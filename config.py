...
# For openai/text-embedding-3-small: true paraphrases score ~0.85+, same-topic
#-but-different-advice ~0.7. At 0.58 a weak scar blocked every sharper lesson
# about the same field from ever being born.
SCAR_DEDUPE_COSINE = 0.80
